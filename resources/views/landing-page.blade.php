<!DOCTYPE html>
    ...
    <head>
        ...
        <!--=============== FAVICON ===============-->
        <link rel="shortcut icon" href="{{ asset('assets/guest/img/favicon.png') }}" type="image/x-icon">

        <!--=============== REMIX ICONS ===============-->
        <link href="https://cdn.jsdelivr.net/npm/remixicon@2.5.0/fonts/remixicon.css" rel="stylesheet">

        <!--=============== CSS ===============-->
        <link rel="stylesheet" href="{{ asset('assets/guest/css/styles.css') }}">
    ...
    <body>
        ...
        <main class="main">
            ...
            <section class="home" id="home">
                <div class="home__container container grid">
                    <img src="{{ asset('assets/guest/img/home.png') }}" alt="" class="home__img">
            ...
            <section class="about section container" id="about">
                <div class="about__container grid">
                    <img src="{{ asset('assets/guest/img/about.png') }}" alt="" class="about__img">
            ...
            <section class="product section container" id="products">
                ...
                <div class="product__container grid">
                    <article class="product__card">
                        ...
                        <img src="{{ asset('assets/guest/img/product1.png') }}" alt="" class="product__img">
                    ...
                    <article class="product__card">
                        ...
                        <img src="{{ asset('assets/guest/img/product2.png') }}" alt="" class="product__img">
                    ...
                    <article class="product__card">
                        ...
                        <img src="{{ asset('assets/guest/img/product3.png') }}" alt="" class="product__img">
                    ...
                    <article class="product__card">
                        ...
                        <img src="{{ asset('assets/guest/img/product4.png') }}" alt="" class="product__img">
                    ...
                    <article class="product__card">
                        ...
                        <img src="{{ asset('assets/guest/img/product5.png') }}" alt="" class="product__img">
                    ...
                    <article class="product__card">
                        ...
                        <img src="{{ asset('assets/guest/img/product6.png') }}" alt="" class="product__img">
            ...
            <div class="footer__container container grid">
                ...
                <div class="footer__content">
                    ...
                    <div class="footer__cards">
                        <img src="{{ asset('assets/guest/img/card1.png') }}" alt="" class="footer__card">
                        <img src="{{ asset('assets/guest/img/card2.png') }}" alt="" class="footer__card">
                        <img src="{{ asset('assets/guest/img/card3.png') }}" alt="" class="footer__card">
                        <img src="{{ asset('assets/guest/img/card4.png') }}" alt="" class="footer__card">
                    </div>
                </div>
            </div>
        ...
        <!--=============== SCROLL REVEAL ===============-->
        <script src="{{ asset('assets/guest/js/scrollreveal.min.js') }}"></script>
